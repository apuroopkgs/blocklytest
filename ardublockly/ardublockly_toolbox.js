...
'    <block type="serialbt_available"></block>' +
'    <block type="serialbt_read"></block>' +
'    <block type="temp_sensor_status"></block>' +
'    <block type="right_sensor_status"></block>' +
'    <block type="left_sensor_status"></block>' +
'    <block type="front_sensor_status"></block>' +
...
'  </category>' +
'  <sep></sep>' +
'  <category id="catSmorphi_logic" name="Smorphi_Logic">' +
'    <block type="controls_if"></block>' +
'    <block type="logic_compare"></block>' +
'    <block type="logic_operation"></block>' +
'    <block type="logic_negate"></block>' +
'    <block type="robot_shape"></block>' +
'    <block type="color_state"></block>' +
